...
const MosaicGlobalRestrictionTransactionBuffer_1 = require("../buffers/MosaicGlobalRestrictionTransactionBuffer");
const MosaicGlobalRestrictionTransactionSchema_1 = require("../schemas/MosaicGlobalRestrictionTransactionSchema");
const VerifiableTransaction_1 = require("./VerifiableTransaction");
const flatbuffers_1 = require("flatbuffers");
const { MosaicGlobalRestrictionTransactionBuffer, } = MosaicGlobalRestrictionTransactionBuffer_1.default.Buffers;
class MosaicGlobalRestrictionTransaction extends VerifiableTransaction_1.VerifiableTransaction {
    constructor(bytes, schema) {
        super(bytes, schema);
    }
}
exports.default = MosaicGlobalRestrictionTransaction;
// tslint:disable-next-line: max-classes-per-file
class Builder {
    constructor() {
        this.maxFee = [0, 0];
        this.type = TransactionType_1.TransactionType.MOSAIC_GLOBAL_RESTRICTION;
    }
    addFee(maxFee) {
        this.maxFee = maxFee;
        return this;
    ...
    build() {
        ...
        // Calculate size
        const codedMosaicGlobalRestriction = MosaicGlobalRestrictionTransactionBuffer.endMosaicGlobalRestrictionTransactionBuffer(builder);
        builder.finish(codedMosaicGlobalRestriction);
        const bytes = builder.asUint8Array();
        const schema = MosaicGlobalRestrictionTransactionSchema_1.default;

...
Crypto.passwordToPrivateKey = (common, walletAccount, algo) => {
    ...
    // Processing
    let r;
    if (algo === WalletAlgorithm_1.WalletAlgorithm.Pass_6k) {
    ...
    else if (algo === WalletAlgorithm_1.WalletAlgorithm.Pass_bip32) {
        const pass = Crypto.derivePassSha(common.password, 20);
        const obj = {
            ciphertext: CryptoJS.enc.Hex.parse(walletAccount.encrypted),
            iv: Convert_1.Convert.hexToUint8(walletAccount.iv),
    ...
    else if (algo === WalletAlgorithm_1.WalletAlgorithm.Pass_enc) {
        const pass = Crypto.derivePassSha(common.password, 20);
        const obj = {
            ciphertext: CryptoJS.enc.Hex.parse(walletAccount.encrypted),
            iv: Convert_1.Convert.hexToUint8(walletAccount.iv),
    ...
    else if (algo === WalletAlgorithm_1.WalletAlgorithm.Trezor) {
        r = { priv: '' };
        common.isHW = true;
    }
    else {
